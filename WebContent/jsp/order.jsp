...
<html lang="en">
  ...
  <body>
    <div class="container box">
      ...
      <div class="d-flex">
        <form name="form" action="orderdb.jsp" method="post" ">
          <label>
          ...
          <label>
            ...
            <input type="tel" name="phno" maxlength="10" required />
          </label>
        ...
        <div class="orderItems">
          <div class="orderItems-products">
			...
			%>
              ...
              <h3 class="total-amount">
                Shipping Charge: <span id="ship"></span>
              </h3>
              <hr />
              <h3 class="total-amount">
                Total: <span id="total"><%=sum+100 %></span>
              </h3>
          </div>
...
<script type="text/javascript">
	var sum="<%=sum%>";
	if(sum==0.0){
		document.getElementById("ship").textContent="0.0";
		document.getElementById("total").textContent="0.0";
	}
	else{
		document.getElementById("ship").textContent="100.0";
	}
