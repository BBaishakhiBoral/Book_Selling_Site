    ...
    <div class="row">
        ...
        <div class="swiper books-slider">
            <div class="swiper-wrapper">
                <a href="#" class="swiper-slide"><img src="../image4/fbook10.jpg" alt=""></a>
                <a href="#" class="swiper-slide"><img src="../image4/fbook11.jpg" alt=""></a>
                <a href="#" class="swiper-slide"><img src="../image4/fbook2.jpg" alt=""></a>
                <a href="#" class="swiper-slide"><img src="../image4/fbook3.jpg" alt=""></a>
            </div>
    ...
    <div class="swiper featured-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <img src="../image4/fbook2.jpg" alt="">
                </div>
                <div class="content">
                     <input type="text" value="LIFE'S AMAZING SECRETS">
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <img src="../image4/fbook9.webp" alt="">
                </div>
                <div class="content">
                     <input type="text" value="WINGS OF FIRE">
                    <div class="price">420 rs <span>500</span></div>
                    <a href="cart.jsp?bn=17" class="btn">add to cart</a>
                    <a href="order2.jsp?bn=17" class="btn">Buy now</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <img src="../image4/fbook10.jpg" alt="">
                </div>
                <div class="content">
                     <input type="text" value="A BIOGRAPHY MANDELA">
                    <div class="price">650 rs <span>900</span></div>
                    <a href="cart.jsp?bn=9" class="btn">add to cart</a>
                    <a href="order2.jsp?bn=9" class="btn">Buy now</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <img src="../image4/fbook11.jpg" alt="">
                </div>
                <div class="content">
                    <input type="text" value="RATAN TATA BIOGRAPHY">
                    <div class="price">320 rs <span>450</span></div>
                    <a href="cart.jsp?bn=10" class="btn">add to cart</a>
                    <a href="order2.jsp?bn=10" class="btn">Buy now</a>
                </div>
            </div>
