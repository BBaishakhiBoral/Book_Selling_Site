    ...
    <div class="row">
        ...
        <div class="swiper books-slider">
            <div class="swiper-wrapper">
                <a href="#" class="swiper-slide"><img src="../image5/2015121049901j34.jpg" alt=""></a>
                <a href="#" class="swiper-slide"><img src="../image5/20226741572j27.jpg" alt=""></a>
                <a href="#" class="swiper-slide"><img src="../image5/81Wkj89RIML.jpg" alt=""></a>
                <a href="#" class="swiper-slide"><img src="../image5/Kalam-Quiz-Book-Hardback-English-SDL701361971-1-a6cd0.jpg" alt=""></a>
            </div>
    ...
    <div class="swiper featured-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <img src="../image5/2015121049901j34.jpg" alt="">
                </div>
                <div class="content">
                    <input type="text" value="PHYSICS QUIZ">
                    <div class="price">350 rs <span>600</span></div>
                    <a href="cart.jsp?bn=19" class="btn">add to cart</a>
                    <a href="order2.jsp?bn=19" class="btn">Buy now</a>
                </div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <img src="../image5/20226741572j27.jpg" alt="">
                </div>
                <div class="content">
                    <input type="text" value="1575 QUIZ">
                    <div class="price">500 rs <span>850</span></div>
                    <a href="cart.jsp?bn=20" class="btn">add to cart</a>
                    <a href="order2.jsp?bn=20" class="btn">Buy now</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <img src="../image5/81Wkj89RIML.jpg" alt="">
                </div>
                <div class="content">
                    <input type="text" value="THE BIG QUIZ BOOK">
                    <div class="price">120 rs <span>200</span></div>
                    <a href="cart.jsp?bn=21" class="btn">add to cart</a>
                    <a href="order2.jsp?bn=21" class="btn">Buy Now</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <img src="../image5/Kalam-Quiz-Book-Hardback-English-SDL701361971-1-a6cd0.jpg" alt="">
                </div>
                <div class="content">
                    <input type="text" value="KALAM QUIZ BOOK">
                    <div class="price">700 rs <span>1400</span></div>
                    <a href="cart.jsp?bn=22" class="btn">add to cart</a>
                    <a href="order2.jsp?bn=22" class="btn">Buy now</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <div class="image">
                    <img src="../image5/The-General-Knowledge-Quiz-Book-SDL238835388-1-a8eb9.jpg" alt="">
                </div>
                <div class="content">
                    <input type="text" value="THE GENERAL KNOWLEDGE QUIZ BOOK">
                    <div class="price">250 rs <span>300</span></div>
                    <a href="cart.jsp?bn=18" class="btn">add to cart</a>
                    <a href="order2.jsp?bn=18" class="btn">Buy now</a>
