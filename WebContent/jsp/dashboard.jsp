...
<head>
    ...
    <link rel="stylesheet" href="../css/final1.css?1422585377">
...
<div class="login-form-container">
    ...
    <form name="form" action="updatedb.jsp" method="post">
        <h3>Update Your password</h3>
        <span>Current Password</span>
        <input type="password" name="opw" class="box" placeholder="enter current password" id="password" value="">
        <span>New Password</span>
        <input type="password" name="npw" class="box" placeholder="enter new password" id="c_password" value="">
        <div class="checkbox">
